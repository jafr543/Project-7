...
private:
    ...
    string _PrepareTransferLogRecord(float Amount,clsBankClient DestinationClient, string Seperator = "#//#")
    {
        ...
        TransferLogRecord += clsDate::GetSystemtimetoString() + Seperator;
...
public:
    ...
    enum enSaveResult { enSvFaildeEmptyObject = 0, enSvSucceeded = 1, svFaildAccountNumberExists = 2 };
    enSaveResult Save()
    {
        ...
        case enMode::EmptyMode:
        {
            if (isEmpty())
            {
                ...
                return enSaveResult::enSvFaildeEmptyObject;
        ...
        case enMode::UpdateMode:
        {
            ...
            return enSaveResult::enSvSucceeded;
    ...
    static double GetClientsTotalBalance()
    {
