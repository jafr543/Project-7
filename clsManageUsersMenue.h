...
class clsManageUsersMenue : protected clsScreen
{
    ...
    {
        cout << setw(18) << left << "" << "Choose what do you want to do? [1 to 6]? ";
    ...
    protected:
        clsManageUsersMenue();
        virtual ~clsManageUsersMenue();
    public:

 static void ShowManageUsersMenue()
    {
           if(!CheckPermission(clsUser::enPermissions::pManageUsers))
    {
        return;
    }
        ...
        cout << setw(16) << left << "" << "===========================================\n";
        cout << setw(20) << left << "" << "\t  Manage Users Menue\n";
        cout << setw(16) << left << "" << "===========================================\n";
